...
public class userAccounts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 230, 40));

        nameew.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        jPanel1.add(nameew, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 220, 60));

        namo1.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        jPanel1.add(namo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 140, 170, 50));

        jLabel9.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel9.setText("Password:");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 120, 40));

        jLabel13.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel13.setText("First Name:");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 120, 40));

        jLabel14.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel14.setText("Last Name:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 120, 40));

        jLabel15.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel15.setText("Email:");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 120, 40));

        gg1.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        jPanel1.add(gg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 230, 40));

        jLabel16.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel16.setText("Username:");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 220, 120, 40));

        user1.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        jPanel1.add(user1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 230, 40));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 230, 30));
